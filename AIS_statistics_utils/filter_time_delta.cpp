...
{   
    ...
    std::vector<int> histogram(1387, 0);
    ...
    {   
        ...
        try {
            ...
            std::cout<<std::string(row[2])<<std::endl;
            first_parsed = false;
...
int main() {
    ...
    start_date.tm_mday = 7;            // Day 1

    // End date: 2023-12-31
    std::tm end_date = {};
    end_date.tm_year = 2023 - 1900;
    end_date.tm_mon = 12;              // December (0-indexed)
    end_date.tm_mday = 31;
